...
local LocalPaste = Window:CreateTab("House Cloner - No PasteBin", "rewind")
Tab:CreateSection("Pastebin Settings")
LocalPaste:CreateSection("Clone")

LocalPaste:CreateButton({
    Name = "Scan House",
    Callback = function()
...
LocalPaste:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({
            Title = "House Successfully Cloned",
            Content = "House Cloned",
            Duration = 6.5,
            Image = 4483362458,
        })
    end,
